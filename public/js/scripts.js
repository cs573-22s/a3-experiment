(() => {
  ...
  var rect = svg1
    ...
    .on("mouseover", (e, d) => {
      ...
      d3.select("#bubble-tip-" + d).style("display", "block");
    })
    .on("mouseout", (e, d) => {
      // event listener to hide tooltip after hover
      if (!d.toolTipVisible) {
        d3.select("#bubble-tip-" + d).style("display", "none");
      }
    })
    .on("click", (e, d) => {
      // event listener to make tooltip remain visible on click
      if (!d.toolTipVisible) {
        d3.select("#bubble-tip-" + d).style("display", "block");
  ...
  const arc2 = d3.arc().innerRadius(0).outerRadius(r2);
  ...
  arcs
    ...
    .on("mouseover", (e, d) => {
      // event listener to show tooltip on hover
      d3.select("#arc-tip-" + d.value).style("display", "block");
    })
    .on("mouseout", (e, d) => {
      // event listener to hide tooltip after hover
      if (!d.toolTipVisible) {
        d3.select("#arc-tip-" + d.value).style("display", "none");
      }
    })
    .on("click", (e, d) => {
      // event listener to make tooltip remain visible on click
